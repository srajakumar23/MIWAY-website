                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 lg:gap-8 divide-x divide-white/10">
                        {[
                            ...
                            <FadeIn key={i} delay={0.1 * i} className="text-center px-4">
                                <div className="text-4xl md:text-5xl lg:text-7xl font-black text-white mb-2 tracking-tighter">{stat.value}</div>
                                <div className="text-[10px] md:text-xs font-bold text-primary uppercase tracking-[0.2em] md:tracking-[0.3em] mb-2">{stat.label}</div>
                            </FadeIn>
                        ))}
                    </div>
                </div>
                ...
                <div className="container relative z-10">
                    <FadeIn>
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 md:gap-12 mb-16 md:mb-24">
                            ...
                            <Link href="/bundles" className="w-full md:w-auto">
                                <Button size="lg" className="w-full md:w-auto rounded-full px-8 md:px-12 py-4 md:py-6 bg-slate-900 text-white text-base md:text-lg font-bold">View All Portfolios</Button>
                            </Link>
                        </div>
                    </FadeIn>
                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                        {[
                            ...
                            <FadeIn key={i} delay={0.2 * i}>
                                <Link href={`/bundles/${bundle.slug}`} className="block h-[400px] md:h-[500px] rounded-[2.5rem] md:rounded-[3.5rem] group relative overflow-hidden ring-1 ring-slate-900/5 cursor-pointer">
                ...
                <div className="container">
                    <div className="grid lg:grid-cols-2 gap-16 md:gap-32 items-center">
                        <FadeIn direction="right">
                            <h2 className="text-xs font-black text-primary uppercase tracking-[0.3em] mb-6 md:mb-8">Our Legacy</h2>
                            ...
                            <Link href="/about" className="inline-block w-full md:w-auto">
                                <Button size="lg" className="w-full md:w-auto bg-primary hover:bg-primary-hover px-8 md:px-12 py-4 md:py-6 rounded-full text-lg md:text-xl font-bold">Read Our Story</Button>
                            </Link>
                        </FadeIn>
                            ...
                            <div className="aspect-[4/5] bg-slate-900 rounded-[3rem] md:rounded-[5rem] overflow-hidden relative shadow-2xl">
                                ...
                                <div className="absolute bottom-6 md:bottom-12 left-6 md:left-12 right-6 md:right-12 z-20">
                                    <div className="bg-white/10 backdrop-blur-xl p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] border border-white/20 shadow-2xl">
                                        ...
                                        <div className="text-[10px] md:text-xs font-bold text-white/90 uppercase tracking-widest">Global Partners</div>
                                    </div>
                                </div>
                            </div>
                        </FadeIn>
